...
public class InvokeLambdaController {
	...
	@RequestMapping("/lambda/{lambda_name}")
	public String invokeLambda(@PathVariable("lambda_name") String lambda_name,@RequestParam String x, @RequestParam String y){
		...
		responsetime = "Response Time is : "+ ( new Date().getTime()- start ) +"ms";
		final_response = "Response from AWS Lambda - "+lambda_name+" :  "+lambdaoutput;
